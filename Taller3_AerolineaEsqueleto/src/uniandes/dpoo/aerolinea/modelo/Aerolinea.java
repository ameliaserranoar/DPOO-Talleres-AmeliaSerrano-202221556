...
public class Aerolinea
{
    ...
    public void agregarVuelo(Vuelo veulito) {
    	vuelos.add(veulito);
    }
    ...
    public Avion getAvionNombre(String  nombre) {
    	Avion retorno = null;
    	for (Avion candidato: aviones) {
    		if ( candidato.getNombre().equals(candidato)){
    			retorno = candidato;
    		}
    	}
    	return retorno;
    ...
    {
    	Collection<Tiquete> salida= new ArrayList<Tiquete>(); 
    	for (int i=0; i<(vuelos.size());i++) {
    ...
    public void programarVuelo( String fecha, String codigoRuta, String nombreAvion ) throws Exception
    {
        ...
        for (Vuelo v:vuelos) {
        	if (v.getFecha().equals(fecha) && v.getAvion().getNombre().equals(nombreAvion)) {
        		throw new Exception ("Avión no disponible");
        	}
        }
    ...
    public int venderTiquetes( String identificadorCliente, String fecha, String codigoRuta, int cantidad ) throws VueloSobrevendidoException, Exception
    {
        ...
        if (ocupados+capacidad>capacidad) {
        	throw new VueloSobrevendidoException(vuelo);
        }
        //String caracter1= String.valueOf(fecha.charAt(5));
        //String caracter2= String.valueOf(fecha.charAt(6));
        //if ((caracter1== "0" )&&(caracter2.equals("1") || caracter2.equals("2")||caracter2.equals("3")||caracter2.equals("4")||caracter2.equals("5")) ) {
    ...
    public String consultarSaldoPendienteCliente( String identificadorCliente )
    {
        ...
        int saldoTotal= cliente.calcularValorTotalTiquetes();
        int saldoRestante= 0;
        List<Tiquete> usados= cliente.getTiquetesUsados();
        for (Tiquete tiquetes:usados) {
        	int tarifa= tiquetes.getTarifa();
        	saldoRestante += tarifa;
        }
        int saldoPendiente= saldoTotal-saldoRestante;
